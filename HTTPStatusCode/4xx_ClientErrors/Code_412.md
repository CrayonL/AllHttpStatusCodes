# HTTP状态码 412 (Precondition Failed) 含义详解
...
与**HTTP状态412**相似的同系列状态码： - [HTTP 407](https://github.com/CrayonL/AllHttpStatusCodes/blob/master/HTTPStatusCode/4xx_ClientErrors/Code_407.md "HTTP 407详细说明")
